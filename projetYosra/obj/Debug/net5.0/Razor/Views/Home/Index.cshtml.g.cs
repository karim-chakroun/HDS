#pragma checksum "C:\Users\Lenovo\source\repos\projetYosra\projetYosra\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3f013e16290f8ae1bbc62e199700cc5cfe0e1527"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3f013e16290f8ae1bbc62e199700cc5cfe0e1527", @"/Views/Home/Index.cshtml")]
...
<section id=""review_home"">
    <div class=""container"">
        <div class=""row"">
            ...
            WriteLiteral(@"r adipiscing elit. Fusce blandit nisi pulvinar, dapibus elit malesuada.</p>
          ...
          ");
            WriteLiteral(@"      <div class=""col-sm-4"">
                ...
                <div class=""col-sm-4"">
                    <div class=""achieve_1m clearfix"">
                        <div class=""achieve_1mi clearfix"">
                            <img src=""img/11.jpg"" class=""iw"" alt=");
            WriteLiteral(@"""abc"">
                        </div>
                        <div class=""achieve_1mi1 text-center clearfix"">
                ...
                <div class=""col-sm-3 space_all"">
                    <a href=""#"">
                        <div class=""achieve_1m clearfix"">
                            <div class=""achieve_1mi clearfix"">
                                <img src=""img/13.jp");
            WriteLiteral(@"g"" class=""iw"" alt=""abc"">
                            </div>
                            <div class=""achieve_1mi1 text-center clearfix"">
            ...
            <div class=""achieve_1 clearfix"">
                <div class=""col-sm-3 space_all"">
                    <a href=""#"">
                        <div class=""achieve_1m clearfix"">
                            <div class=""achieve_1mi clearfix"">
                                <img src=""img/16.jpg"" class=""iw"" alt=""ab");
            WriteLiteral(@"c"">
                            </div>
                            <div class=""achieve_1mi1 text-center clearfix"">
                                <h3 class=""bold col"">Being Free</h3>
                ...
                <div class=""col-sm-3 space_all"">
                    <a href=""#"">
                        <div class=""achieve_1m clearfix"">
                            ...
                            <div class=""ach");
            WriteLiteral(@"ieve_1mi1 text-center clearfix"">
                                <h3 class=""bold col"">Role  Model</h3>
                                <h4 class=""col_1"">SUCCESS</h4>
                            </div>
                        </div>
            ...
            <div class=""review_home_1 clearfix"">
                <div class=""col-sm-6"">
                    <div class=""review_home_1l clearfix"">
                        ...
                        <h5><a class=""button"" href=""#"">READ MORE <i class=""fa fa-chevron-right""></i></a></h5>
                        <h5><a class=""button_1"" href=""#"">TA");
            WriteLiteral(@"KE A  TOUR <i class=""fa fa-chevron-right""></i></a></h5>
                    </div>
                </div>
                <div class=""col-sm-6"">
                    <div class=""review_home_1r clearfix"">
    ...
    <div class=""container"">
            ...
            <div class=""strategy_1 clearfix"">
                <div class=""col-sm-12"">
                    <div class=""panel panel-success"">
                        ...
                        <div clas");
            WriteLiteral(@"s=""panel-body clearfix"">
                            <p>
                                <li> Instructeur international krav maga</li>
                                <li>  Instructeur free styl defense system</li>
                                <li> 4eme dan taekwondo ENTRAÎNEUR  FÉDÉRAL kick boxing</li>
                    ...
                    <div class=""panel panel-success"">
                        <div class=""panel-heading clickable"">
                            <h3 class=""panel-title"">
                              ");
            WriteLiteral(@"  <i class=""fa fa-fire""></i> Profession
                            </h3>
                            <span class=""pull-right ""><i class=""glyphicon glyphicon-minus""></i></span>
                        </div>
        ...
        ");
            WriteLiteral(@"            <div class=""panel panel-success"">
                        <div class=""panel-heading clickable"">
                            <h3 class=""panel-title"">
                                <i class=""fa fa-shield""></i> Qualifications et spécialisations HDS 
            ...
            WriteLiteral(@"            </p>
                    ...
                    <div class=""panel panel-success"">
                        <div class=""panel-heading clickable"">
                            <h3 class=""panel-title"">
                                <i class=""fa fa-graduation-cap""></i>   HARD WORK
                            </h3>
                            <span class=""pull-right ""><i class=""glyphicon glyphicon-minus""></i></span>
                        </div>
                        <div class=""panel-body clearfix"">
                            <p>  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio.Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu eget nulla.Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitursodales ligula in libero.S");
            WriteLiteral(@"ed dignissim lacinia nunc.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=""league_1 clearfix"">
                    ...
                    <div class=""col-sm-3"">
                        <div class=""league_1i clearfix"">
                            ...
                            <h4 class=""bold"">Champion League  <span>2002</s");
            WriteLiteral(@"pan></h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elitimus.</p>
                        </div>
                    </div>
    ...
    <div class=""container"">
        <div class=""row"">
            ...
            <div class=""achieve_1 clearfix"">
                <div class=""col-sm-3"">
                    <div class=""achieve_1m clearfix"">
                        <div class=""achieve_1mi clearfix"">
                            <img ");
            WriteLiteral(@"src=""img/30.jpg"" class=""iw"" alt=""abc"">
                        </div>
                        <div class=""achieve_1mi1 text-center clearfix"">
            ...
            WriteLiteral(@"ix"">
                ...
                <div class=""col-sm-3"">
 ");
            WriteLiteral(@"                   <div class=""achieve_1m clearfix"">
                        <div class=""achieve_1mi clearfix"">
